...
public class SimpleRuleInt extends Rule<int[]> {
    ...
    public SimpleRuleInt(AXAnimatorUpdateListener<Integer> listener, int... data) {
        super(data);
        this.listener = listener;
    }

    public SimpleRuleInt(AXAnimatorUpdateListener<Integer> listener, LiveVar<int[]> data) {
        super(data);
        this.listener = listener;
    }
