...
/**
 * A custom {@link Rule} using {@link ObjectAnimator} and {@link ArgbEvaluator}
 *
 * @author AmirHossein Aghajari
 */
public class RuleObjectColor extends Rule<int[]> {
    final String propertyName;

    public RuleObjectColor(String propertyName, int... data) {
        super(data);
        this.propertyName = propertyName;
    }

    public RuleObjectColor(String propertyName, LiveVar<int[]> data) {
        super(data);
        this.propertyName = propertyName;
    }
