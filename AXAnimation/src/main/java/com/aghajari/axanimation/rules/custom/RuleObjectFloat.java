 ...
 */
public class RuleObjectFloat extends Rule<float[]> {
    final String propertyName;

    public RuleObjectFloat(String propertyName, float... data) {
        super(data);
        this.propertyName = propertyName;
    }

    public RuleObjectFloat(String propertyName, LiveVar<float[]> data) {
        super(data);
        this.propertyName = propertyName;
    }
    ...
    public Animator onCreateAnimator(@NonNull final View view, final LayoutSize target, final LayoutSize original, final LayoutSize parentSize) {
        return initEvaluator(ObjectAnimator.ofFloat(view, propertyName, data));
    }
}
